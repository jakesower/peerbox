import { createInitiator, createReceiver } from "./webrtc/peer-connection";
import createSignalHandler from "./webrtc/signal-handler";
import { signalerPath } from "../../config";
...
export default function (room, initManifest) {
  const protocol =
    (window.location.protocol === 'https:' ? 'wss://' : 'ws://') +
    window.location.host +
    window.location.pathname;
  const uri = room ? (signalerPath + room) : signalerPath;
